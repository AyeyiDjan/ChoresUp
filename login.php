...
{   
    ...
    $insert = mysqli_query($db,"SELECT * from `residents` WHERE (`Email`='$email' AND `House_Head`='No') ");
    $insert2 = mysqli_query($db,"SELECT * from `residents` WHERE (`House_Id`='$house ' AND `Email`='$email' ) ");
    $insert3 = mysqli_query($db,"SELECT * from `house` WHERE (`House_Id`='$house' AND `House_Password`= md5('$password')) ");
     if(mysqli_num_rows($insert)==1 && mysqli_num_rows($insert2)==1 && mysqli_num_rows($insert3)==1)
    {
      //Store variables in session
       $_SESSION['email']= $email;
       $_SESSION['house']= $house;
       
       header("location:Members-View.php"); // redirects to members view page
        exit;   
    }
    else
    {
     ...
     $insert4 = mysqli_query($db,"SELECT * from `residents` WHERE (`Email`='$email' AND `House_Head`='Yes') ");
    $insert5 = mysqli_query($db,"SELECT * from `residents` WHERE (`House_Id`='$house ' AND `Email`='$email' ) ");
    $insert6 = mysqli_query($db,"SELECT * from `house` WHERE (`House_Id`='$house' AND `House_Password`= md5('$password')) ");
     if(mysqli_num_rows($insert4)==1 && mysqli_num_rows($insert5)==1 && mysqli_num_rows($insert6)==1)
    {
      //Store variables in session
       $_SESSION['email']= $email;
       $_SESSION['house']= $house;
       
       header("location:admin\AdminDashboard.php"); // redirects to members view page
        exit;   
    }
    else
    {
...
<link rel="stylesheet" href="LOGIN.css" media="screen">
  ...
  <body class="u-body u-overlap u-overlap-transparent"><header class="u-clearfix u-header u-header" id="sec-0978"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-5-base u-text-hover-palette-5-base" href="login.php" style="padding: 10px 0px;">Login</a>
</li></ul>
          </div>
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="carousel_0931">
            ...
            <div class="u-layout-row">
              <div class="u-align-center u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <img class="u-image u-image-1" src="images/gc8dfe141800bd7855172934c77c2cec3bf889e32ffdd08116f747be4e8d272e7fe78d0436451106d506a6eb78b45b909_1280.png" data-image-width="807" data-image-height="1280">
                </div>
              </div>
...
?>
                    <form action="login.php" method="POST" >
                      <div class="u-form-email u-form-group">
                        ...
                        <input type="email" placeholder="Enter your email" id="email-3b9a" name="email" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle " required="">
                      </div>
                      <div class="u-form-group u-form-select u-form-group-2">
                        <label for="select-3477" class="u-form-control-hidden u-label"></label>
                        <div class="u-form-select-wrapper">
                          <select id="select-3477" name="house" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle " required="required">
      ...
      ob_end_clean();
        ...
        //Display houses that are in the database
...
?>
                      ...
                      <div class="u-form-group">
                        ...
                        <input placeholder="Enter your House Password" rows="4" cols="50" id="message-3b9a" name="password" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle " required="required" type="password">
                      </div>
                      <div class="u-align-center u-form-group u-form-submit">
                        <input type="submit" name="login" value="LOGIN" class="u-border-2 u-border-custom-color-2 u-btn u-btn-rectangle u-btn-submit u-button-style u-custom-color-2 u-btn-1">

                      </div>
                    </form>
                  </div>
                  <p class="u-small-text u-text u-text-default u-text-variant u-text-2">Dont have an account?</p>
                  <p class="u-small-text u-text u-text-default u-text-variant u-text-3">
                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" href="SIGNUP.php" data-page-id="216229204">SignUp.</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-footer u-white" id="sec-5c66"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-align-center-lg u-align-center-md u-align-center-xl u-text u-text-1">Web Technologies Individual Project<br>Nana Banyin Ayeyi Djan<br>98312023<br>Class of 2023
        </p>
